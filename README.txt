...
Simply execute the me.bantling.j2ee.basics.run.J2EEBasicsFrameworksJetty class as a plain old Java application, and it
will start up Jetty and wait for you to terminate the process.
...
|  me.bantling.j2ee.basics.controller.listener  |  Log web apps, Log requests, add filter to servlets |                                 |
